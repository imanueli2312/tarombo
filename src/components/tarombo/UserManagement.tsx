...
const roleColors: Record<string, string> = {
  ...
  EDITOR: "bg-[var(--t-bg-warm)] text-[var(--t-text)]",
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold text-[var(--t-text)]">Kelola Pengguna</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div className="p-3 bg-[var(--t-bg-warm)] rounded-lg border border-[var(--t-border)]">
          <p className="font-semibold text-[var(--t-text)] text-sm">Editor</p>
          <p className="text-xs text-[var(--t-text-sec)] mt-1">Tambah dan edit data anggota & pernikahan</p>
        </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="hover:bg-[var(--t-bg-warm)]/50">
                    ...
                    <TableHead className="text-[var(--t-text)]">Email</TableHead>
                    <TableHead className="text-[var(--t-text)]">Role</TableHead>
                    <TableHead className="text-[var(--t-text)]">Status</TableHead>
                    <TableHead className="text-[var(--t-text)] text-right">Aksi</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {users.map((user) => (
                    <TableRow key={user.id} className="hover:bg-[var(--t-bg-warm)]/50">
                      <TableCell className="font-medium text-[var(--t-text)]">{user.name}</TableCell>
