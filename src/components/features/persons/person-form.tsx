  ...
  useEffect(() => {
    if (open && person) {
      reset({
        ...
        marga_asal: ((person as Record<string, unknown>).marga_asal as string) || '',
        tempat_asal: ((person as Record<string, unknown>).tempat_asal as string) || '',
        pendidikan: ((person as Record<string, unknown>).pendidikan as string) || '',
        pekerjaan: ((person as Record<string, unknown>).pekerjaan as string) || '',
        keterangan: ((person as Record<string, unknown>).keterangan as string) || '',
